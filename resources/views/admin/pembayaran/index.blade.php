      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-9 col-12">
            <h4 class="my-1 text-success font-weight-bold">Daftar Transaksi Pembayaran</h4>
            <p class="my-1">Berikut adalah daftar transaksi pembayaran Bedug Langgeng</p>
          </div>
        ...
        <div class="row mx-md-3 mt-3 pt-2">
          <div class="col-12">
            <div class="table-responsive">
              <table id="pembayaran-table" class="table" style="overflow-x:auto;">
                <thead class="text-success">
                  <th class="font-weight-normal" style="min-width:60px;"><p class="mb-2 mr-3">No</p></th>
                  <th class="font-weight-normal" style="min-width:140px;"><p class="mb-2 mr-3">Tanggal Pembayaran</p></th>
                ...
                <tbody>
                  @for($i=0;$i<count($order);$i++)
                    <tr>
                      <td>{{$i+1}}</td>
                      <td>{{date_format($pembayaran[$i]->created_at,"d F Y H:i")}}</td>
