...
<head>
  ...
  <!-- CSS Files -->
  <link href="{{asset('admin_assets/assets/css/material-dashboard.css?v=2.1.1')}}" rel="stylesheet" />
  <!-- datatable -->
  <link rel="stylesheet" type="text/css" href="{{asset('admin_assets/assets/js/datatables.min.css')}}"/>
  @yield('style')
</head>
...
<body class="">
  ...
  <script src="{{asset('admin_assets/assets/js/plugins/fullcalendar.min.js')}}"></script>
  ...
  <!-- Chartist JS -->
  <script src="{{asset('admin_assets/assets/js/plugins/chartist.min.js')}}"></script>
  <!--  Notifications Plugin    -->
  <script src="{{asset('admin_assets/assets/js/plugins/bootstrap-notify.js')}}"></script>
  <!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="{{asset('admin_assets/assets/js/material-dashboard.js?v=2.1.1')}}" type="text/javascript"></script>
  <!-- dataTables -->
  <script type="text/javascript" src="{{asset('admin_assets/assets/js/datatables.min.js')}}"></script>
