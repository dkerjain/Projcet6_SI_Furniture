      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: left;">
			            <img src="{{asset('image/logo.png')}}" style="width:250px" alt="">
                  <p style="margin-top:0; font-weight:normal; color:#000; padding-left:1.5em; font-size:12px;">Alamat Rumah 
            <br>Alamat Bengkel Kerja :
          ...
          <td valign="middle" class="hero bg_white" style="padding: 1em 0 1em 0;">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		...
            		<p style="color:black; margin-bottom:0; font-weight:bold">Kepada</p>
        ...
        <tr>
          <td valign="middle" class="bg_white">
            <table class="bg_white" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <th width="70%" style="text-align:right; color: #000; padding: 1em 2.5em;">Total Pembayaran</th>
  					  	<th width="30%" style="text-align:center; color: #000; padding:;">Rp {{number_format($order->biaya_total_produk,0,',','.')}}</th>
  					  </tr>
            </table>
          </td>
        </tr>
          ...
          <td valign="middle" class="bg_white" style="padding: 1em 0 1em 0;">
            <table class="bg_white" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                @if ($order->status_pembayaran==0)
                <p style="color:black; margin-top:0;">Transfer ke BRI 123456789 A.N Budi Nur Cahyo 
                <br>BNI 123456789 A.N Budi Nur Cahyo</p>
                @elseif ($order->status_pembayaran==1)
                <p style="color:black; margin-top:0;">Hormat kami, Bedug Langgeng</p>
                @endif
              </tr>
